        ...
        <div class="card-body">
            <form>
                ...
                <div class="form-group row">
                    ...
                    <input class="col-sm-6 form-control" type="date" name="date">
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">อายุ</label>
                    <input class="col-sm-6 form-control" type="number" name="age" placeholder="กรอกอายุ">
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <select class="col-sm-4 form-control" id="fav-color" name="fav-color">
